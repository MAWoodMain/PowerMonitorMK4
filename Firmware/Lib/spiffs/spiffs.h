...
/* spi read call function type */
typedef s32_t (*spiffs_read)(u32_t addr, u32_t size, u8_t *dst, void* cardFs, void* spi, void* channel);
/* spi write call function type */
typedef s32_t (*spiffs_write)(u32_t addr, u32_t size, u8_t *src, void* cardFs, void* spi, void* channel);
/* spi erase call function type */
typedef s32_t (*spiffs_erase)(u32_t addr, u32_t size, void* cardFs, void* spi, void* channel);
...
typedef struct {
    ...
    /* Extra fields to support my SPI abstraction */
    void* cardFs;
    void* spi;
    void* channel;
